...
null_dist_money
###
prop1(~ diffmean <= obs_diff_mean, data = null_dist_money)
###
...
The line representing our observed difference in mean is located in the center of the null distribution, this suggests that the observed difference is quite common under the null hypothesis which states that there is no effect of gender on spending.
